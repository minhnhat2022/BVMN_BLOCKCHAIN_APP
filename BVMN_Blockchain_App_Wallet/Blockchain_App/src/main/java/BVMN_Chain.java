...
public class BVMN_Chain {
    ...
    public static BVMN_Wallet walletA; //Ví A
    public static BVMN_Wallet walletB; //Ví B
    ...
    public static void main(String[] args) {
        ...
        //Tạo ra các ví
        walletA = new BVMN_Wallet();
        walletB = new BVMN_Wallet();
        BVMN_Wallet coinbase = new BVMN_Wallet();
